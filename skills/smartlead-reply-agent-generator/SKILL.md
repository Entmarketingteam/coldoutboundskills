...
NEVER DRAFT AN ANSWER FOR automatically — don't wait to be asked. For IISH-adjacent campaigns
this overlaps with the compliance gate in `iish-launch-resources/.claude/rules/iish.md`
(structure/function claims only, no menopause *treatment* framing) — reconcile against that
file directly if the campaign is IISH's, don't re-derive the rules here.
